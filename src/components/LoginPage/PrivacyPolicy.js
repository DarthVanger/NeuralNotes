...
const PrivacyPolicy = () => (
  <>
    ...
    <p>
      At NeuralNotes, accessible from https://neural-notes.com, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by
      NeuralNotes and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in NeuralNotes. This policy is not applicable to any
    ...
    <p>
      NeuralNotes follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, NeuralNotes uses 'cookies'. These cookies are used
    ...
    <p>
      ...
      advertising partners of NeuralNotes.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on NeuralNotes, which are sent
    ...
    <p>
      Note that NeuralNotes has no access to or control over these cookies that
    ...
    <p>
      NeuralNotes's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      NeuralNotes does not knowingly collect any Personal Identifiable
