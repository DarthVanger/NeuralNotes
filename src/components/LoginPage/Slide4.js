...
const CaptionBoxSlide4 = ({ viewBoxWidth = 36, viewBoxHeight = 22, ...rest }) => {
        ...
        return (
            <Slide>
                <Figure className='mind-map'>
                    ...
                    <CaptionBoxSlide4 viewBoxWidth="38" left="31%" top="41.5%" width="7.5%">
                        <CaptionTextSlide4 x="2" y="16" text="Rock" />
                    </CaptionBoxSlide4>
                    <CaptionBoxSlide4 viewBoxWidth="44" viewBoxHeight="36" left="20.5%" top="74%" width="8.5%">
                        <CaptionTextSlide4 x="5" y="14" text="Visit" />
                        <CaptionTextSlide4 y="32" text="Africa" />
                    </CaptionBoxSlide4>
                    <CaptionBoxSlide4 viewBoxWidth="60" viewBoxHeight="15" left="61%" top="81%" width="11.5%">
                        <CaptionTextSlide4 text="Keep fit"/>
                    </CaptionBoxSlide4>
                    <CaptionBoxSlide4 left="73.5%" top="63%" width="8.5%" fontWeight="700">
                        <CaptionTextSlide4 text="Art"/>
                    </CaptionBoxSlide4>
                    <CaptionBoxSlide4 viewBoxWidth="45" left="36%" top="23.5%" width="10.5%" fontWeight="700">
                        <CaptionTextSlide4 y="16" text="Music"/>
                    </CaptionBoxSlide4>
                    <CaptionBoxSlide4 viewBoxWidth="58" left="32.5%" top="57.5%" width="13.5%" fontWeight="700">
                        <CaptionTextSlide4 text="Dreams"/>
                    </CaptionBoxSlide4>
                    <CaptionBoxSlide4 viewBoxWidth="45" left="76%" top="36.5%" width="9.5%" fontWeight="700">
