...
const TermsOfService = () => (
  <>
    ...
    <p>
      By accessing this Website, accessible from https://neural-notes.com, you
    ...
    <p>
      ...
      NeuralNotes's Website for personal, non-commercial transitory viewing
    ...
    <ul>
      ...
      <li>
        attempt to reverse engineer any software contained on NeuralNotes's
        Website;
      </li>
      <li>
    ...
    <p>
      This will let NeuralNotes to terminate upon violations of any of these
    ...
    <p>
      All the materials on NeuralNotes’s Website are provided "as is".
      NeuralNotes makes no warranties, may it be expressed or implied, therefore
      negates all other warranties. Furthermore, NeuralNotes does not make any
    ...
    <p>
      NeuralNotes or its suppliers will not be hold accountable for any damages
      that will arise with the use or inability to use the materials on
      NeuralNotes’s Website, even if NeuralNotes or an authorize representative
    ...
    <p>
      The materials appearing on NeuralNotes’s Website may include technical,
      typographical, or photographic errors. NeuralNotes will not promise that
      any of the materials in this Website are accurate, complete, or current.
      NeuralNotes may change the materials contained on its Website at any time
      without notice. NeuralNotes does not make any commitment to update the
      materials.
    </p>
    ...
    <p>
      NeuralNotes has not reviewed all of the sites linked to its Website and is
      not responsible for the contents of any such linked site. The presence of
      any link does not imply endorsement by NeuralNotes of the site. The use of
    ...
    <p>
      NeuralNotes may revise these Terms of Use for its Website at any time
    ...
    <p>
      Any claim related to NeuralNotes's Website shall be governed by the laws
      of ua without regards to its conflict of law provisions.
    </p>
  </>
);
